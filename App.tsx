...
import {
    ...
    PhoneIcon,
    LightBulbIcon,
    FeatureLightBulbIcon,
    CommunityBuildersIcon,
    CertificateIcon,
    TrophyIcon,
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div className="hidden sm:flex items-center space-x-2">
                <a
                    ...
                    className="text-white font-semibold py-2 px-4 rounded-lg hover:bg-slate-800/60 transition-colors"
                >
                    View Agenda
                </a>
                <a
...
const Hero: React.FC<{
    onExplore: (e: React.MouseEvent<HTMLAnchorElement>) => void;
}> = ({ onExplore }) => (
    <div className="relative isolate overflow-hidden">
        ...
        <div
            ...
            aria-hidden="true"
        >
            <div className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#a855f7] to-[#4f46e5] opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"></div>
        </div>
        <div className="relative max-w-4xl mx-auto text-center py-32 sm:py-48 px-4">
            <h1 className="text-3xl font-bold tracking-tight">
                <span className="gradient-text">
                    Be Future-Ready: Build with AI, Solve with Purpose
                </span>
            </h1>
            ...
            <p className="mt-6 text-lg sm:text-xl text-slate-300 max-w-3xl mx-auto">
                🚀 Join our 2-day hands-on workshop to turn your ideas into
                solutions for real-world problems in your community. Build
                solutions using AI – no tech skills required!
            </p>
            <div className="mt-10">
                <a
                    href="#projects"
    ...
    <div className="py-16 sm:py-24">
        <div className="max-w-4sm mx-auto text-center px-4">
            ...
            <p className="mt-4 text-xl text-slate-400 max-w-3xl mx-auto">
                In this immersive class, you’ll learn how to harness AI to build
                real-world projects that matter — for your community, school, or
                workplace, this workshop will help you go from{" "}
                <span className="font-bold text-indigo-300">
                    idea to interactive prototype
                </span>{" "}
                — using powerful{" "}
                <span className="font-bold text-indigo-300">no-code tools</span>
                .
            </p>
        </div>
    </div>
...
const whoIsThisForData = [
    {
        ...
        title: "Entrepreneurs",
        description:
            "To build your MVP products and bring your ideas to life quickly.",
    },
    {
        icon: <AcademicCapIcon />,
        title: "Students",
        description:
            "To learn about AI tools to create prototypes without coding in the future.",
    },
    {
        icon: <CommunityBuildersIcon />,
        title: "Community Builders",
        description:
            "To create tools and platforms that support and grow your community.",
    },
    {
        icon: <FeatureLightBulbIcon />,
        title: "Anyone Curious",
        description:
            "Who wants to create real-world impact with AI — without writing a single line of code.",
    },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
                ...
                <p className="mt-4 max-w-2xl mx-auto text-xl text-slate-400">
                    This workshop is designed for a diverse group of creators
                    and thinkers.
                </p>
            </div>
            <div className="mt-16 grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                {whoIsThisForData.map((item) => (
                    <div
                        key={item.title}
                        className="bg-slate-900 p-8 rounded-2xl ring-1 ring-slate-800 text-center hover:ring-indigo-500 transition-all duration-300 transform hover:-translate-y-1"
                    >
...
const whatYoullTakeHomeData = [
    {
        ...
        description:
            "Your very own functional app to showcase and continue building.",
    },
    {
        icon: <CertificateIcon />,
        title: "A Digital Certificate",
        description:
            "Official recognition of your new skills and workshop completion.",
    },
    {
        icon: <SparklesIcon />,
        title: "The Confidence to Build with AI",
        description:
            "The know-how and inspiration to continue creating with AI.",
    },
];
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="mt-8 space-y-8">
                    {whatYoullTakeHomeData.map((item) => (
                        <div
                            key={item.title}
                            className="flex items-start p-6 bg-slate-900 rounded-2xl ring-1 ring-slate-800"
                        >
...
const instructorsData = [
    {
        name: "Lee Wei Song",
        role: "AI Engineer",
        image: "https://i.ibb.co/9HD33QR3/1.png",
    },
    {
        name: "Tan Sin Chee",
        role: "AI Engineer",
        image: "https://i.ibb.co/xqWWkpJw/2.png",
    },
];
...
const hackathonAchievements = [
    ...
    {
        rank: "3rd Place",
        event: "Xiamen Malaysia-China Youth Innovation Competition 2024",
    },
    {
        rank: "4th Place",
        event: "Penang Young Digital Talent Game Development Competition",
    },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
                ...
                <p className="mt-4 text-xl text-slate-400 max-w-2xl mx-auto">
                    Learn from industry experts passionate about empowering
                    creators with AI.
                </p>
            </div>
            <div className="flex flex-col md:flex-row gap-8">
                <div className="flex flex-col gap-8 md:w-[30%]">
                    {instructorsData.map((instructor) => (
                        <div
                            key={instructor.name}
                            className="bg-slate-900 p-8 rounded-2xl ring-1 ring-slate-800 flex-1"
                        >
                            <div className="text-center">
                                <img
                                    src={instructor.image}
                                    alt={`Photo of ${instructor.name}`}
                                    className="w-36 h-36 rounded-full object-cover ring-4 ring-slate-700 mx-auto"
                                />
                ...
                <div className="bg-slate-900 p-8 rounded-2xl ring-1 ring-slate-800 md:w-[70%]">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-12">
                        <div>
                            <h4 className="text-xl font-semibold text-indigo-300 mb-4 text-center lg:text-left">
                                CTF Competitions
                            </h4>
                    ...
                    <div className="mt-12 border-t border-slate-700 pt-12">
                        ...
                        <div className="max-w-sm mx-auto relative">
                            <div className="absolute -top-5 left-1/2 -translate-x-1/2 z-10">
                                <span className="bg-gradient-to-r from-fuchsia-600 to-purple-600 text-white text-[10px] sm:text-xs font-semibold uppercase tracking-wider px-2.5 py-1 rounded-full shadow-md">
                                    EARLY BIRD OFFER
                                </span>
                            </div>
                            <div className="bg-gradient-to-br from-fuchsia-500 via-purple-600 to-indigo-500 p-1 rounded-[1.25rem] shadow-lg">
                                <div className="bg-slate-900 rounded-2xl p-8 text-center">
                                    <div className="mt-6 flex items-baseline justify-center gap-x-3">
                                        <span className="text-6xl sm:text-4xl font-extrabold bg-gradient-to-r from-fuchsia-400 to-pink-500 text-transparent bg-clip-text">
                                            RM599
                                        </span>
                                        <span className="text-4xl sm:text-xl font-medium text-slate-500 line-through">
                                            RM899
                                        </span>
                                    </div>
    ...
    <footer className="bg-slate-900 border-t border-slate-800">
        <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 text-center">
            <p className="text-center text-base text-slate-500">
                &copy; 2024 Nestspace. All rights reserved.
            </p>
        </div>
    </footer>
);
